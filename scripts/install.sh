...
install_packages() {
  packages=("zip" "ntfs-3g" "tree" "discord" "lazygit" "ufw" "zsh" "unzip" "wget" "stow" "curl" "yazi" "neovim" "eza" "btop" "gamemode" "steam" "mangohud" "zoxide" "fzf" "bat" "kitty" "geany" "geany-plugins" "tmux" "jdk23-openjdk" "docker" "ripgrep" "rofi" "feh" "wireplumber" "pipewire-pulse" "polybar" "cargo" "fd" "pavucontrol" "alsa-utils" "xclip" "python-i3ipc")
