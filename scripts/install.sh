...
case $answer in
  ...
  #3)
	...
	#;;
  4)
    install_packages "pacman" "zip" "discord" "lazygit" "ufw" "zsh" "unzip" "wget" "stow" "curl" "yazi" "vim" "eza" "btop" "gamemode" "steam" "mangohud" "zoxide" "fzf" "bat" "kitty" "geany" "geany-plugins" "tmux" "jdk23-openjdk"
    configure_git
    config_ufw
    install_nitch
    install_themes
